 ...
 * @file
 *
 * Defines the {@link SpectrogramView} class.
 *
...
function SpectrogramView(waveformData, spectrogramData, container, peaks, viewOptions) {
  const self = this;
  ...
  if (self._viewOptions.showSpectrogram) {
...
SpectrogramView.prototype.getViewOptions = function() {
...
SpectrogramView.prototype.getWaveformData = function() {
  return this._data;
};

SpectrogramView.prototype.setWaveformData = function(waveformData) {
  this._data = waveformData;
};

SpectrogramView.prototype.getSpectrogramData = function() {
...
SpectrogramView.prototype.timeToPixels = function(time) {
...
SpectrogramView.prototype.pixelsToTime = function(pixels) {
...
SpectrogramView.prototype.pixelOffsetToTime = function(offset) {
  const pixels = this._frameOffset + offset;

  return pixels * this._data.scale / this._data.sample_rate;
};

SpectrogramView.prototype.timeToPixelOffset = function(time) {
...
SpectrogramView.prototype.getFrameOffset = function() {
...
SpectrogramView.prototype.getWidth = function() {
  return this._width;
};
...
SpectrogramView.prototype.getHeight = function() {
  return this._height;
};
...
SpectrogramView.prototype.getStartTime = function() {
...
SpectrogramView.prototype.getEndTime = function() {
...
SpectrogramView.prototype._getDuration = function() {
  return this._peaks.player.getDuration();
};

SpectrogramView.prototype._createWaveform = function() {
...
SpectrogramView.prototype._createWaveformShapes = function() {
...
SpectrogramView.prototype.setPlayedWaveformColor = function(color) {
...
SpectrogramView.prototype._destroyPlayedWaveformShape = function() {
...
SpectrogramView.prototype._createAxisLabels = function() {
...
SpectrogramView.prototype.showAxisLabels = function(show, options) {
  this._axis.showAxisLabels(show, options);
  this._axisLayer.draw();
};

SpectrogramView.prototype.setAxisLabelColor = function(color) {
  this._axis.setAxisLabelColor(color);
  this._axisLayer.draw();
};

SpectrogramView.prototype.setAxisGridlineColor = function(color) {
  this._axis.setAxisGridlineColor(color);
  this._axisLayer.draw();
};

SpectrogramView.prototype.showPlayheadTime = function(show) {
  this._playheadLayer.showPlayheadTime(show);
};

SpectrogramView.prototype.setTimeLabelPrecision = function(precision) {
  this._timeLabelPrecision = precision;
  this._playheadLayer.updatePlayheadText();
};

SpectrogramView.prototype.formatTime = function(time) {
  return this._formatPlayheadTime(time);
};

/**
 * Adjusts the opacity of the spectrogram shown in the view.
 *
 * @param {Number} opacity The new opacity factor
 */

SpectrogramView.prototype.setOpacity = function(opacity) {
  if (!isNumber(opacity) || !isFinite(opacity)) {
    throw new Error('view.setOpacity(): Opacity must be a valid number');
  }

  this._spectrogramOpacity = opacity;
  if (this._spectrogramImage) {
    this._spectrogramImage.setOpacity(this._spectrogramOpacity);
  }
};
...
SpectrogramView.prototype.setAmplitudeScale = function(scale) {
...
SpectrogramView.prototype.getAmplitudeScale = function() {
  return this._amplitudeScale;
};

SpectrogramView.prototype.enableSeek = function(enable) {
  this._enableSeek = enable;
};

SpectrogramView.prototype.isSeekEnabled = function() {
  return this._enableSeek;
};

SpectrogramView.prototype._onClick = function(event) {
  this._clickHandler(event, 'click');
};

SpectrogramView.prototype._onDblClick = function(event) {
  this._clickHandler(event, 'dblclick');
};

SpectrogramView.prototype._onContextMenu = function(event) {
  this._clickHandler(event, 'contextmenu');
};

SpectrogramView.prototype._clickHandler = function(event, eventName) {
...
SpectrogramView.prototype.updatePlayheadTime = function(time) {
  this._playheadLayer.updatePlayheadTime(time);
};

SpectrogramView.prototype.playheadPosChanged = function(time) {
  if (this._playedWaveformShape) {
...
SpectrogramView.prototype.drawWaveformLayer = function() {
  this._waveformLayer.draw();
};

SpectrogramView.prototype.enableMarkerEditing = function(enable) {
  if (this._segmentsLayer) {
...
SpectrogramView.prototype.dragSeek = function(dragging) {
  if (this._segmentsLayer) {
...
SpectrogramView.prototype.fitToContainer = function() {
...
SpectrogramView.prototype.destroy = function() {
