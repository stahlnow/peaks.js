...
function SpectrogramZoomView(waveformData, spectrogramData, container, peaks) {
  ...
  SpectrogramView.call(
    self, waveformData, spectrogramData, container, peaks, peaks.options.spectrogramZoomview
  );
...
SpectrogramZoomView.prototype = Object.create(SpectrogramView.prototype);

SpectrogramZoomView.prototype.initWaveformData = function() {
...
SpectrogramZoomView.prototype.initHighlightLayer = function() {
};
...
SpectrogramZoomView.prototype.isAutoZoom = function() {
...
SpectrogramZoomView.prototype.updateWaveform = function(frameOffset, forceUpdate) {
  let upperLimit;
...
SpectrogramZoomView.prototype.containerWidthChange = function() {
  let resample = false;
  let resampleOptions;
...
SpectrogramZoomView.prototype.containerHeightChange = function() {
  this._spectrogramImage.update();
};
